...
import LanguageSelector from '@/Components/LanguageSelector.vue'; // <--- IMPORTANTE: Tu componente de idioma
import { Link, usePage } from '@inertiajs/vue3';

const showingNavigationDropdown = ref(false);
const page = usePage(); // Para acceder a las props globales fácilmente si hace falta
</script>
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('students.index')" :active="route().current('students.*')">
                                    {{ $page.props.translations.students }}
                                </NavLink>

                                <NavLink :href="route('projects.index')" :active="route().current('projects.*')">
                                    {{ $page.props.translations.projects }}
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('logout')" method="post" as="button">
                                            {{ $page.props.translations.logout || 'Log Out' }}
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
                            </div>
